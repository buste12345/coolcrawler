...
#MONGODB_COLLECTION = "open_news_celtest"
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_ROOT, 'scraperfunc.db'),                      # Or path to database file if using sqlite3.
...
#DATABASE_ROUTERS = ['open_news.routers.MongoDBRouter']
DATABASE_ROUTERS = ['gui.routers.guiDBRouter']
...
##LOGIN_REDIRECT_URL = '/AdminLTE/starter.html'
LOGIN_REDIRECT_URL = '/'
...
ROOT_URLCONF = 'coolcrawler.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'coolcrawler.wsgi.application'
